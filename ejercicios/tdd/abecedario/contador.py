            ...
            try:
                if elem is s:
                    ...
                    if mensaje[0] == "contar-letra":
                        ...
                        texto = mensaje [2:]
                        texto = "".join(texto)
                        contador = Contador.contarLetra(contador, letra, texto)
                        ...
                        texto = mensaje[2:]
                        texto = "".join(texto)
                        contador = Contador.contarString(contador, cadena, texto)
                        elem.send(str(contador).encode("utf-8"))
                        ...
                        texto = mensaje[4:]
                        texto = "".join(texto)
                        contador = Contador.contarVariasLetras(contador, arrayletras, texto)
                        elem.send(str(contador).encode("utf-8"))
